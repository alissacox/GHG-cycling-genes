...
Note: This analysis pipeline requires a working Linux terminal. This pipeline ran successfully several Windows 10 machines with the Linux Subsystem enabled using Ubuntu (18.04). These commands also ran without problem on a native Ubuntu (18.04) installation.
